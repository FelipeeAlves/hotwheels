...
function Admin() {
  ...
  // Inicializando o objeto já com a categoria padrão 'Hotwheels'
  const [novoProduto, setNovoProduto] = useState({ nome: '', preco: '', tamanho: '', imagem: '', categoria: 'Hotwheels' });
  ...
  const cadastrarProduto = async (e) => {
    ...
    formData.append('nome', nomeFormatado); // 🆕 Agora enviamos o nome já formatado!
    ...
    try {
      ...
      if (resposta.ok) {
        ...
        setNovoProduto({ nome: '', preco: '', tamanho: '', imagem: '', categoria: 'Hotwheels' });
  ...
  const deletarProduto = async (id) => {
    if (confirm("Tem certeza que deseja deletar este hotwheels?")) {
      try {
  ...
  return (
    <div className="admin-container">
      <header className="admin-header">
        ...
        <p className="admin-subtitle">Gerencie os produtos e pedidos Hotwheels</p>
      </header>
              ...
              produtos.map((prod) => (
                <li key={prod._id} className="lista-item">
                  <div className="item-info">
                    ...
                    <span className="item-detalhes">Categoria: {prod.categoria || 'Hotwheels'} | Tamanho: {prod.tamanho} cm | R$ {prod.preco}</span>
                  </div>
