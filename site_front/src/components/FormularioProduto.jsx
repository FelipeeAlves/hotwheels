...
function FormularioProduto({ onProdutoCadastrado }) {
  ...
  return (
    <div style={styles.formContainer}>
      <h3> + Cadastrar Novo Hotwheels</h3>
      <form onSubmit={handleSubmit} style={styles.form}>
        <input type="text" placeholder="Nome do Hotwheels (ex: Porsche)" value={nome} onChange={(e) => setNome(e.target.value)} required style={styles.input}/>
        <input type="text" placeholder="Preço (ex: R$ 59,90)" value={preco} onChange={(e) => setPreco(e.target.value)} required style={styles.input}/>
        <input type="text" placeholder="Marca (ex: Porsche)" value={tamanho} onChange={(e) => setTamanho(e.target.value)} required style={styles.input}/>
        <input type="text" placeholder="URL da Imagem" value={imagem} onChange={(e) => setImagem(e.target.value)} required style={styles.input}/>
